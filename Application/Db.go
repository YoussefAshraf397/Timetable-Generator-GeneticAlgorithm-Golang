...
func makeConnection() *gorm.DB {
	dsn := os.Getenv("DATABASE_USER_NAME") + ":" + os.Getenv("DATABASE_PASSWORD") + "@tcp(" + os.Getenv("DATABASE_USER_HOST") + ":" + os.Getenv("DATABASE_USER_PORT") + ")/" + os.Getenv("DATABASE_NAME") + "?charset=utf8mb4&parseTime=True&loc=Local"
	fmt.Println(dsn)
